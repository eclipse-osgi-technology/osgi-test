...
public class BundleDTOAssert extends AbstractBundleDTOAssert<BundleDTOAssert, BundleDTO> {
	...
	public static final InstanceOfAssertFactory<BundleDTO, BundleDTOAssert> BUNDLE_DTO = new InstanceOfAssertFactory<>(
		BundleDTO.class, BundleDTOAssert::assertThat);
