...
public class FrameworkDTOAssert extends AbstractFrameworkDTOAssert<FrameworkDTOAssert, FrameworkDTO> {
	...
	public static final InstanceOfAssertFactory<FrameworkDTO, FrameworkDTOAssert> FRAMEWORK_DTO = new InstanceOfAssertFactory<>(
		FrameworkDTO.class, FrameworkDTOAssert::assertThat);
